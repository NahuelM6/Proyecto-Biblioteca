...
public class Redondeadorrojo extends JButton {
	
	public Redondeadorrojo(String label) {
        super(label);
	...
	protected void paintComponent(Graphics g) {
	    ...
	    if (getModel().isArmed()) {
	    	Color colorpersonalizadobotonpresionado = new Color(245, 74, 59);
	        g2.setColor(colorpersonalizadobotonpresionado); // apretado
	    } else {
	    	Color colorpersonalizadoboton = new Color(178, 74, 59);
