...
public class ModificarInventario extends JFrame {
	...
	public ModificarInventario(String isbn,String titulo,String autor,String genero,int año, String tipo) {
        ...
        JLabel NSLI = new JLabel ("Numero de serie", SwingConstants.CENTER);  
        ...
        txtAELI.setText(String.valueOf(año));
		...
		tiposLibros.setSelectedItem(genero);
		
		JLabel GLI = new JLabel ("Genero", SwingConstants.CENTER);  
        panelLibros.add(GLI);
        ...
        modificar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String ISBN = txtIDLII.getText().trim(); 
                    String titulo = txtTLI.getText().trim();
                    String autor = txtALI.getText().trim();
                    String año = txtAELI.getText().trim();
                    String tipo = tiposLibros.getSelectedItem().toString();
                    String genero = txtGLI.getText().trim();

                 
                    if (ISBN.isEmpty() || titulo.isEmpty() || autor.isEmpty() || año.isEmpty() || genero.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Todos los campos deben estar completos.");
                        return;
                    }

                    
                    controlador.modificarinv(ISBN, titulo, autor, año, tipo, genero);
