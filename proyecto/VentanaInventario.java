    ...
    protected void paintContentBorder(Graphics g, int tabPlacement, int selectedIndex) {
        ...
        modificar1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	String tipo = "hola";
            	     int año = 0;
            	     JComboBox tiposLibros = new JComboBox();
            	int seleccionada = tablainventarioLib.getSelectedRow();
            	
            	if(seleccionada != -1) {
            		
            	 isbn = (String) tablainventarioLib.getValueAt(seleccionada, 5);
            	 titulo = (String) tablainventarioLib.getValueAt(seleccionada,  0);
            	 autor = (String) tablainventarioLib.getValueAt(seleccionada, 1);
            	 genero = (String) tablainventarioLib.getValueAt(seleccionada, 4);
            	  año = Integer.parseInt(tablainventarioLib.getValueAt(seleccionada, 2).toString());

            	 tipo = (String) tablainventarioLib.getValueAt(seleccionada, 3);
            	 tiposLibros.setSelectedItem(tipo);
            	}
            	
            	
            	
                controlador.ModificarInventario(isbn,año,autor,genero,titulo,tipo);
                VentanaInventario.this.dispose();
            }
        });
